<footer class="footer footer-center border-t border-[#FA7070] p-10 bg-[#FEFDED] text-[#FA7070]">
  <aside>
    ...
    <p class="font-bold">
      Ananta Risky Susanto - 225150601111013
    </p> 
    <p class="font-bold">
    Irba Sakilah - 2251506001111007
    </p> 
    <p class="font-bold">
    Muhammad Luthfi Zahran Elwino - 225150607111030
    </p> 
    <p class="font-bold">
    Jeihan Shinta Maharani – 225150600111034
    </p> 
    <p>Copyright © 2024 - Kelompok 3</p>
  </aside> 
  <nav>
